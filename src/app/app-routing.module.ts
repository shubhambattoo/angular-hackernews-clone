...
const routes: Routes = [
  ...
  { path: 'news/:page', component: ShowStoriesComponent, data: { feed: 'news' } },
  { path: 'newstories/:page', data: { feed: 'newest' }, component: ShowStoriesComponent },
  { path: 'beststories/:page', data: { feed: 'best' }, component: ShowStoriesComponent },
  { path: 'askstories/:page', data: { feed: 'ask' }, component: ShowStoriesComponent },
